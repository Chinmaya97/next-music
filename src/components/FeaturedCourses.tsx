        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {featuredCourse.map((course: Course) => (
            <div key={course.id} className="flex justify-center">
              <BackgroundGradient className="flex flex-col h-full rounded-[22px] max-w-sm  bg-white dark:bg-zinc-900 overflow-hidden">
                <div className="p-4 sm:p-6 flex flex-col items-center yext-center flex-grow">
